...
const Cprogramming = () => {
  return (
    <section id="c">
      <div className="rounded-[40px]  bg-[url('https://media.geeksforgeeks.org/wp-content/cdn-uploads/20230630120259/C-Language-Introduction.png')] bg-cover bg-no-repeat bg-center mx-10 h-80 "></div>
