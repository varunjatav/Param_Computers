...
const DigitalMarketing = () => {
  return (
    <section id="digital_marketing">
      <div className="rounded-[40px]  bg-[url('https://www.berlinsbi.com/uploads/sites/2/2021/12/5-ways-msc-digital-marketing-will-advance-your-career.jpg')] bg-cover bg-no-repeat bg-top mx-10 h-80 "></div>
      ...
      <aside className="flex-initial m-auto lg:m-0 w-80 rounded-[20px] border-2 h-[450px] p-10">
        ...
        <p className="text-gray-500 flex gap-3 items-center mb-1">
          <MdOutlineLiveTv /> 5 months live classes
        </p>
        <p className="text-gray-500 flex gap-3 items-center mb-1">
        ...
        <hr className="my-8" />
        <p className="font-bold text-2xl text-emerald-700 pb-2">
          &#8377; 15999
        </p>
        <p className="font-bold text-2xl text-emerald-700 pb-5">
          &#8377; 500 (Registration)
        </p>
        <Link to={"/development/digital-marketing-payment"}
          type="button"
